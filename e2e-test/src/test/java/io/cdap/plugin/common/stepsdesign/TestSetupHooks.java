...
public class TestSetupHooks {
  ...
  @After(order = 1, value = "@BQ_SOURCE_TEST or @BQ_SOURCE_DATETRANSFORM_TEST or @BQ_SOURCE_LOOKUP_TEST")
  ...
  @Before(order = 1, value = "@GCS_CSV_LOOKUP_TEST")
  public static void createBucketWithNormalizeFile() throws IOException, URISyntaxException {
    createGCSBucketWithFile(PluginPropertyUtils.pluginProp("lookUpGCSCsvFile"));
  }

  @After(order = 1, value = "@GCS_CSV_LOOKUP_TEST")
